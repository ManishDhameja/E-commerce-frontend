import {
      ...
      <Card>
        ...
        >
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary" textOverflow={"ellipsis"} overflow="hidden" maxHeight="40px">
              {item.desc}
            </Typography>
          </CardContent>
        </CardActionArea>
  ...
  export default function NewArrivals() {
    ...
    return (
      <Box
        sx={{
          p: (theme) => theme.spacing(lessThan1250 ? (lessThan600 ? 2 : 4) : 8),
        }}
      >
        <Divider>
